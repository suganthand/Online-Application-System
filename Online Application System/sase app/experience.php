...
$target_dir = "uploads/";
$file ='';
$expDocTooLarge = false;
$expExtnInvalid = false;
$expUploadOk = false;
$expUploaded = false;
$flag = false;
$status = 0;
...
if(isset($_FILES["exp"]["name"]))
{
    ...
    if($expUploadOk)
    {
        if (move_uploaded_file($_FILES["exp"]["tmp_name"], $expFile))
        {
            ...
            $update = "UPDATE experience_uploads SET status=TRUE, file='$file', size='$file_size', type='$filetype'  WHERE applicant_id='$appid'";
        ...
        else
        {
            ...
            $update = "UPDATE experience_uploads SET status=FALSE, file='', size='', type=''  WHERE applicant_id='$appid'";
            $result = mysql_query($update) or die(mysql_error());
        }
    }
}

$select = "SELECT status, file FROM experience_uploads WHERE applicant_id='$appid'";
            ...
            <div class="TabBody">
                <table width="114%">
                    ...
                    <tr>
                        ...
                        <td style="font-size:12px">
                            <a href="criticalessay.php">Critical Essay</a>
                        </td>
                    </tr>
                </table>
            </div>
            <div align="center">
                <form name="experience" action="experience.php" method="post" class="AdvancedForm" enctype="multipart/form-data">
                    <table align="center" cellpadding="3" cellspacing="2">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if($expUploaded==false && $expExtnInvalid==true)
                                {
                                    echo "<b><p style=color:red>Invalid extension! Only .doc files allowed!</p></b>";
                                }

                                if($expUploaded==false && $expDocTooLarge==true)
                                {
                                ...
                                if($expUploaded==true)
                                {
                                    ...
                                    echo "<input type='file' name='exp' id='exp'>
                                          <input type='submit' value='Replace' name='expUpload'>";
                                }

                                if($expUploaded==false && $status==1)
                                {
                                    echo "<a href=\"uploads/$file\">View uploaded file</a>";
                                    echo "<input type='file' name='exp' id='exp'>
                                          <input type='submit' value='Replace' name='expUpload'>";
                                ...
                                if($expUploaded==false && $status==0)
                                {   echo "<b><p style=color:red>No file uploaded!</p></b>";
                                    echo "<input type='file' name='exp' id='exp'>
                                          <input type='submit' value='Upload' name='expUpload'>";
                                }
                                ?>
