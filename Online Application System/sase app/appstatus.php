...
$select = "SELECT app_status FROM users WHERE email='$username'";
...
<div align="center">
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            <h2 align="center" class="contentblock">Application Status</h2>
            ...
            <table width="75%" align="center" id="new">
                <tr>
                    <th align="left" id="new" class="new2">Application and Year</th>
                    <th align="left" id="new" class="new2">Status</th>
                </tr>
                <tr>
                    <td id="new" class="new2">MSIT- Software Engineering 2016-17</td>
                    <td id="new" class="new2"><?php
                         if($flag==0) echo "<a href=\"instructions.php\">Start Application</a>";
                         if($flag==1) echo "<a href=\"instructions.php\">Resume Application</a>";
                         if($flag==2) echo "<a href=\"instructions.php\">View Submitted Application</a>";
                        ?>
                    </td>
                </tr>
            </table>
