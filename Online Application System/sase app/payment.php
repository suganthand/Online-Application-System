...
$select = "SELECT email, applicant_id, validation_status FROM users WHERE email='$username'";
...
<div align="center">
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            ...
            <div align="center">
                <br><br><br>
                <form name="payment" action=" https://pgi.billdesk.com/pgidsk/PGIMerchantPayment" method="post" class="AdvancedForm">
                    <table align="center" cellpadding="3" cellspacing="2">
                        <tr>
                            <td>
                                <b>Application Fee Payment</b>
                            </td>
                        </tr>
                        <?php
                        if($flag)
                        {
                            ...
                            <tr>
                                <td colspan="70">
                                    <b>Please proceed to pay INR 1200. </b>
                                </td>
                            </tr>
                            <?php
                        }
                        else
                        {
                            ...
                            <tr>
                                <td colspan="70">
                                    <b>Your application is not complete. All mandatory fields must be completed before
                                    you can proceed to payment.</b>
                                </td>
                            </tr>
                            <?php
                        }
