    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            ...
            <div class="TabBody">
                ...
                $middlename = mysql_escape_string($_POST['mname']);
                ...
                $insert="INSERT INTO users(email, salt, password, first_name, middle_name, last_name, phone) VALUES ('$username','$user_salt','$hashedpass','$firstname','$middlename','$lastname','$phone')";
                $result = mysql_query($insert);

                if(mysql_affected_rows())
                {
                    echo "<h3 align=center> Registration successful! </h3>";
                    echo "<p align=center> You will be redirected to the login page in 5 seconds. Or you can <a href=\"login.php\">click here</a></p>";
                    ?>
                    <script type="text/javascript">
                        setTimeout(function()
                        {
