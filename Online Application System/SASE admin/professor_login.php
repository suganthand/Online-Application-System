...
if(count($_POST)>0)
{
    ...
    $find_user = "SELECT email FROM professors WHERE email='$form_username'";
    $result = mysql_query($find_user);
    if(mysql_affected_rows())
    {
        $find_pass = "SELECT salt, password, email, first_name FROM professors WHERE email='$form_username'";
...
{
    header("Location:professor_selection.php");
}
?>
...
<div align="center">
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            <h2 align="center" class="contentblock">Professor Login</h2>
            <div class="TabBody">
