...
<div align="center">
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            <h2 align="center" class="contentblock">Registration Status</h2>
            <div class="TabBody">
                <?php
                ...
                $insert="INSERT INTO professors(email, salt, password, first_name, last_name ) VALUES ('$username','$user_salt','$hashedpass','$firstname','$lastname')";
                $result = mysql_query($insert);

                if(mysql_affected_rows())
                {
                    echo "<h3 align=center> Registration successful! </h3>";
                    echo "<p align=center> You will be redirected to the login page in 5 seconds. Or you can <a href=\"professor_login.php\">click here</a></p>";
                    ?>
                    <script type="text/javascript">
                        setTimeout(function()
                        {
                            window.location.href="professor_login.php"; // the redirect goes here
                        },5000);
                    </script>
                    <?php
                }
                else echo "<p align=center> Registration failure! Please try again after sometime.</p>";
                mysql_close();
                ?>
